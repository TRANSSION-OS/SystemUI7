 ...
 */
public class TaskTalpaViewTransform {
     ...
     */
    public void fillIn(TaskTalpaView tv) {
    ...
    /**
     * Copies the transform state from another {@link TaskTalpaViewTransform}.
     */
    public void copyFrom(TaskTalpaViewTransform other) {
     ...
     */
    public boolean isSame(TaskTalpaViewTransform other) {
     ...
     */
    public void applyToTaskView(TaskTalpaView v, ArrayList<Animator> animators,
