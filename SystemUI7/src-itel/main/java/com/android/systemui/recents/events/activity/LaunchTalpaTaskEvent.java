...
public class LaunchTalpaTaskEvent extends EventBus.Event {
    ...
    public LaunchTalpaTaskEvent(TaskTalpaView taskView, Task task, Rect targetTaskBounds,
                                int targetTaskStack, boolean screenPinningRequested) {
