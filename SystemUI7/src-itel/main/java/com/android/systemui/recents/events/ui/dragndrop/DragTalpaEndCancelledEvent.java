 ...
 */
public class DragTalpaEndCancelledEvent extends EventBus.AnimatedEvent {

    public final TaskStack stack;
    public final Task task;
    public final TaskTalpaView taskView;

    public DragTalpaEndCancelledEvent(TaskStack stack, Task task, TaskTalpaView taskView) {
        this.stack = stack;
        this.task = task;
