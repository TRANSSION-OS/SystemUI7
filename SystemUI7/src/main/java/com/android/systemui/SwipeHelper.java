        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_CANCEL:
                ...
                if (!handleUpEvent(ev, mCurrView, velocity, getTranslation(mCurrView))) {
                    ...
                    if (isDismissGesture(ev) && (getTranslation(mCurrView) < 0) && !mCallback.isLockedIcon(mCurrView)) {//<0, slide to left
                    /* @} */
                        // flingadingy
                        ...
                        /* SPRD: Bug 535096 new feature of lock recent apps @{ */
                        if ((swipedFastEnough() || swipedFarEnough()) && (getTranslation(mCurrView) > 0)) {//>0 slide to right
