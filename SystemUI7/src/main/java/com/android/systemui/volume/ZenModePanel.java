...
public class ZenModePanel extends LinearLayout {
    ...
    private static String foreverSummary(Context context) {
        return context.getString(Resources.getSystem().getIdentifier("zen_mode_forever", "string","android"));
    }
...
//        LogUtil.i("enabled="+enabled);
        ...
        // talpa@andy 2017/5/8 17:26 fex bug:cdn#9952 横屏状态栏下拉唤出通知栏，
        // 点击勿扰快捷开关进入勿扰二级界面，上下滑动有效区域太小，建议调整优化@{
