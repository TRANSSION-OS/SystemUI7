...
abstract public class SafetyWarningDialog extends SystemUIDialog
    ...
    public SafetyWarningDialog(Context context, AudioManager audioManager) {
        ...
        setMessage(mContext.getString(Resources.getSystem().getIdentifier("safe_media_volume_warning", "string","android")));
        setButton(DialogInterface.BUTTON_POSITIVE,
                mContext.getString(Resources.getSystem().getIdentifier("yes", "string","android")), this);
        setButton(DialogInterface.BUTTON_NEGATIVE,
                mContext.getString(Resources.getSystem().getIdentifier("no", "string","android")), (OnClickListener) null);
