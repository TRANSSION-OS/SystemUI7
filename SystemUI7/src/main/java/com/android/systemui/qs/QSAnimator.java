...
public class QSAnimator implements Callback, PageListener, Listener, OnLayoutChangeListener,
    ...
    public static final float EXPANDED_TILE_DELAY = 0f; //.7f; //modified by lych
    private static final float LAST_ROW_EXPANDED_DELAY = 0f; //.86f; //modified by lych
...
//                translationYBuilder.addFloat(quickTileView, "translationY", 0, yDiff);
                ...
                //talpa zhw modify firstPageBuilder.addFloat(tileView, "translationY", mQsPanel.getHeight(), 0);
...
//                mAllViews.add(quickTileView);
                ...
                lastRowBuilder.addFloat(tileView, "alpha", 1/*0*/, 1); // modified by lych :
            }
        ...
        if (mAllowFancy) {
            ...
            mFirstPageDelayedAnimator = new TouchAnimator.Builder()
                    ...
                    .addFloat(mQsPanel.getTileLayout(), "alpha", 1/*0*/, 1).build(); // modified by lych
