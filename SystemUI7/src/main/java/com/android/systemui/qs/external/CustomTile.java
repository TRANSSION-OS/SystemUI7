...
import com.android.systemui.qs.customize.QSCustomIconView;
import com.android.systemui.qs.external.TileLifecycleManager.TileChangeListener;
import com.android.systemui.statusbar.phone.QSTileHost;

import itel.transsion.settingslib.utils.BitmapUtils;
...
public class CustomTile extends QSTile<QSTile.State> implements TileChangeListener {
    ...
    public QSIconView createTileView(Context context) {
        return new QSCustomIconView(context);
    }
    ...
    protected void handleUpdateState(State state, Object arg) {
        ...
        int size = mContext.getResources().getDimensionPixelSize(R.dimen.itel_qs_tile_image_size);
        // talpa@andy 2017/4/7 13:43 modify @{
        state.icon = new DrawableIcon(BitmapUtils.getInstance().
                zoomDrawable(drawable, size, size, mContext.getResources()));
