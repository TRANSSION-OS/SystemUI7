...
public class QSTileBaseView extends LinearLayout {
    ...
    // talpa@andy 2017/5/10 15:39 fix bug:cdn#9956下拉唤出通知栏，连续点击蓝牙快捷开关，
    // 动画切换效果很慢@{
    public QSTile getQSTile() {
        return mQSTile;
    }

    public void setQSTile(QSTile mQSTile) {
...
//        LogUtil.i("handleStateChanged>tile="+mQSTile.getClass().getSimpleName());
        mIcon.setIcon(state);
    ...
    private void updateTopPadding() {
        int padding = getResources().getDimensionPixelSize(R.dimen.qs_quick_tile_padding);
