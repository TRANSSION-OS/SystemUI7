...
//            R.drawable.ic_landscape_to_auto_rotate);
    ...
    private Icon mPortrait = ResourceIcon.get(R.drawable.itel_ic_qs_portrait);
    private Icon mlandscape = ResourceIcon.get(R.drawable.itel_ic_qs_auto_rotate_on);
...
//            state.icon = portrait ? mPortraitToAuto : mLandscapeToAuto;
        ...
        //talpa zhw add
        state.bottomIcon = ResourceIcon.get(R.drawable.itel_ic_qs_portrait_bottom);
        //talpa zhw add end
    }
