...
public abstract class QSTile<TState extends State> {
    ...
    // talpa@andy 2017/5/23 16:38 add @{
    ...
    private void handleStateChanged() {
        ...
        if (mCallbacks.size() != 0) {
            // talpa@andy 2017/6/26 17:12 modify: 解决ncd#10407 开启飞行模式后，
            // 偶现通知栏接界面的飞行模式开关图标显示关闭状态@{
    ...
    public interface Host {
        ...
        // shaolin add
        int getBarState();
        PhoneStatusBar getStatusBar();

        StatusBarWindowView getStatusBarWindow();
    ...
    public static class State {
        ...
        public boolean copyTo(State other) {
            ...
            other.bottomIcon = bottomIcon; //talpa zhw add
