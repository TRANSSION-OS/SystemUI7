...
public class CellularTile extends QSTile<QSTile.SignalState> {
    ...
    protected void handleUpdateState(SignalState state, Object arg) {
        ...
        final int iconId = cb.noSim ? R.drawable.ic_qs_data_off
                : !mDataController.isMobileDataEnabled() || cb.airplaneModeEnabled ? R.drawable.ic_qs_data_off
                /* : cb.mobileSignalIconId > 0 ? cb.mobileSignalIconId*/
...
//        state.activityOut = cb.enabled && cb.activityOut;
        ...
        state.label = mDataController.isMobileDataEnabled()
                ? removeTrailingPeriod(cb.enabledDesc)
                : r.getString(R.string.quick_settings_rssi_emergency_only);

        final String signalContentDesc = mDataController.isMobileDataEnabled() && (cb.mobileSignalIconId > 0)
        ...
        if (cb.noSim) {
            ...
            String enabledDesc = mDataController.isMobileDataEnabled() ? r.getString(R.string.accessibility_cell_data_on)
