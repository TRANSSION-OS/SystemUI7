...
//        mCellMarginTop = res.getDimensionPixelSize(R.dimen.qs_tile_margin_top);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        //modified by chenzehngjun start
//        mCellWidth = (width - (mCellMargin * (mColumns + 1))) / mColumns;
        mCellWidth = (width - 2*mCellMargin) / mColumns;
...
//                (mCellHeight + mCellMargin) * rows + (mCellMarginTop - mCellMargin));
    ...
    private int getRowTop(int row) {
        //modifien by chenzhengjun start
        return row * mCellHeight;//row * (mCellHeight + mCellMargin) + mCellMarginTop;
        //modified by chenzhengjun end
    }
    ...
    private int getColumnStart(int column) {
        ...
        int width = column * mCellWidth + mCellMargin;
        return width; //column * (mCellWidth + mCellMargin) + mCellMargin;
        //modified by chenzhengjun end
        // @}
    }
}
