...
import itel.transsion.systemui.storage.MtkStorageManagerEx;
...
class SaveImageInBackgroundTask extends AsyncTask<Void, Void, Void> {
    ...
    SaveImageInBackgroundTask(Context context, SaveImageInBackgroundData data,
        ...
        if (TalpaUtils.isSPRDPlatform()) {
            ...
            //Talpa: lych begin for fixed bug 11181, save path of screenshot in mtk case
//            mScreenshotDir = new File(Environment.getExternalStoragePublicDirectory(
//                    Environment.DIRECTORY_PICTURES), SCREENSHOTS_DIR_NAME);
            mScreenshotDir = Environment.buildPath(new File(MtkStorageManagerEx.getDefaultPath()),
                    Environment.DIRECTORY_PICTURES,SCREENSHOTS_DIR_NAME);
            // Talpa: lych end for fixed bug 11181, save path of screenshot in mtk case
        }
        // @}
...
//        c.drawColor(overlayColor);
        ...
        mPublicNotificationBuilder = new Notification.Builder(context)
                ...
                .setShowWhen(true)
                .setColor(r.getColor(
                        TalpaResUtil.android.color.system_notification_accent_color()));
        ...
        mNotificationBuilder = new Notification.Builder(context)
            ...
            .setWhen(now)
            .setShowWhen(true)
            .setColor(r.getColor(TalpaResUtil.android.color.system_notification_accent_color()))
    ...
    protected Void doInBackground(Void... params) {
        ...
        try {
            ...
            Notification.Action.Builder shareActionBuilder = new Notification.Action.Builder(
                    ...
                    r.getString(TalpaResUtil.android.string.share()), shareAction);
            ...
            Notification.Action.Builder deleteActionBuilder = new Notification.Action.Builder(
                    ...
                    r.getString(TalpaResUtil.android.string.delete()), deleteAction);
...
class GlobalScreenshot {
    ...
    private void saveScreenshotInWorkerThread(Runnable finisher) {
        ...
        // Talpa:PeterHuang bug fix ncd#10526, avoid the null pointer before saving image. @{
        if (data.image == null) {
            LogUtil.i("The image is null before saving it!");
            return;
        }
        // @}
