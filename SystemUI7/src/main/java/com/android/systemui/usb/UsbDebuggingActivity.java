...
public class UsbDebuggingActivity extends AlertActivity
    ...
    public void onCreate(Bundle icicle) {
        ...
        View checkbox = inflater.inflate(Resources.getSystem().getIdentifier("always_use_checkbox", "layout","android"), null);
        mAlwaysAllow = (CheckBox)checkbox.findViewById(Resources.getSystem().getIdentifier("alwaysUse", "id","android"));
