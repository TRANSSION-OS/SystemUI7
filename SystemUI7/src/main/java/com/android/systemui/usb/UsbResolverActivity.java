...
public class UsbResolverActivity extends ResolverActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CharSequence title = getResources().getText(Resources.getSystem().getIdentifier("chooseUsbActivity", "string","android"));
        ...
        CheckBox alwaysUse = (CheckBox)findViewById(Resources.getSystem().getIdentifier("alwaysUse", "id","android"));
        if (alwaysUse != null) {
            if (mDevice == null) {
