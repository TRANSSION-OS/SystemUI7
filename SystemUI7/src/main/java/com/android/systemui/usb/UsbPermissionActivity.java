...
public class UsbPermissionActivity extends AlertActivity
    ...
    public void onCreate(Bundle icicle) {
       ...
       Intent intent = getIntent();
        ...
        ap.mView = inflater.inflate(Resources.getSystem().getIdentifier("always_use_checkbox", "layout","android"), null);
        mAlwaysUse = (CheckBox)ap.mView.findViewById(Resources.getSystem().getIdentifier("alwaysUse", "id","android"));
        if (mDevice == null) {
        ...
        mClearDefaultHint = (TextView)ap.mView.findViewById(
                                                    Resources.getSystem().getIdentifier("clearDefaultHint", "id","android"));
