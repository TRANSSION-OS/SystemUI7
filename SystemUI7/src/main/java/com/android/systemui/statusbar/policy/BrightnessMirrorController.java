...
public class BrightnessMirrorController {
    ...
    private ImageView mAutoControlView;
    //talpa zhw add end
    ...
    public BrightnessMirrorController(StatusBarWindowView statusBarWindow) {
        ...
        //talpa zhw add
        mAutoControlView = (ImageView) mBrightnessMirror.findViewById(R.id.brightness_auto_control_icon);
        mAutomaticAvailable = mStatusBarWindow.getContext().getResources().getBoolean(
    ...
    public void showMirror() {
        ...
        {
            int automatic;
            automatic = Settings.System.getIntForUser(mStatusBarWindow.getContext().getContentResolver(),
                    Settings.System.SCREEN_BRIGHTNESS_MODE,
                    Settings.System.SCREEN_BRIGHTNESS_MODE_MANUAL,
                    UserHandle.USER_CURRENT);
            boolean mAutomatic = automatic != Settings.System.SCREEN_BRIGHTNESS_MODE_MANUAL;
            mAutoControlView.setImageResource(mAutomatic?
                    R.drawable.ic_qs_brightness_auto_on_control:
                    R.drawable.ic_qs_brightness_auto_off_control);
        }
        else
        {
            mAutoControlView.setImageResource(com.android.systemui.R.drawable.ic_qs_brightness_auto_on);
        }
        //talpa zhw add end
