...
public class PhoneStatusBarPolicy implements Callback, RotationLockController.RotationLockControllerCallback, DataSaverController.Listener {
    ...
    public PhoneStatusBarPolicy(Context context, StatusBarIconController iconController,
        ...
        mSlotCast = context.getString(Resources.getSystem().getIdentifier("status_bar_cast", "string","android"));
        mSlotHotspot = context.getString(Resources.getSystem().getIdentifier("status_bar_hotspot", "string","android"));
        mSlotBluetooth = context.getString(Resources.getSystem().getIdentifier("status_bar_bluetooth", "string","android"));
        mSlotTty = context.getString(Resources.getSystem().getIdentifier("status_bar_tty", "string","android"));
        mSlotZen = context.getString(Resources.getSystem().getIdentifier("status_bar_zen", "string","android"));
        mSlotVolume = context.getString(Resources.getSystem().getIdentifier("status_bar_volume", "string","android"));
        mSlotAlarmClock = context.getString(Resources.getSystem().getIdentifier("status_bar_alarm_clock", "string","android"));
        mSlotManagedProfile = context.getString(
                Resources.getSystem().getIdentifier("status_bar_managed_profile", "string","android"));
        mSlotRotate = context.getString(Resources.getSystem().getIdentifier("status_bar_rotate", "string","android"));
        mSlotHeadset = context.getString(Resources.getSystem().getIdentifier("status_bar_headset", "string","android"));
        mSlotDataSaver = context.getString(Resources.getSystem().getIdentifier("status_bar_data_saver", "string","android"));
        ...
        // TTY status
        mIconController.setIcon(mSlotTty,  R.drawable.itel_stat_sys_tty_mode, null);
        ...
        // Alarm clock
        //mIconController.setIcon(mSlotAlarmClock, R.drawable.stat_sys_alarm, null);//linwujia edit
        mIconController.setIcon(mSlotAlarmClock, R.drawable.itel_stat_sys_alarm, null);
        mIconController.setIconVisibility(mSlotAlarmClock, false);

        // zen
        mIconController.setIcon(mSlotZen, R.drawable.itel_stat_sys_zen_important, null);
        mIconController.setIconVisibility(mSlotZen, false);

        // volume
        mIconController.setIcon(mSlotVolume, R.drawable.itel_stat_sys_ringer_vibrate, null);
        mIconController.setIconVisibility(mSlotVolume, false);
        updateVolumeZen();

        // cast
        mIconController.setIcon(mSlotCast, R.drawable.itel_stat_sys_cast, null);
        ...
        /// George:changed for different platform
        if(TalpaUtils.isMTKPlatform()) {
            mIconController.setIcon(mSlotHotspot, R.drawable.itel_stat_sys_hotspot,
                    mContext.getString(R.string.accessibility_status_bar_hotspot));
            mIconController.setIconVisibility(mSlotHotspot, mHotspot.isHotspotEnabled());
            mHotspot.addCallback(mHotspotCallback);
        }else{
        ...
        // managed profile
        mIconController.setIcon(mSlotManagedProfile, R.drawable.itel_stat_sys_managed_profile_status,
                mContext.getString(R.string.accessibility_managed_profile));
        mIconController.setIconVisibility(mSlotManagedProfile, mManagedProfileIconVisible);

        // data saver
        mIconController.setIcon(mSlotDataSaver, R.drawable.itel_stat_sys_data_saver,
    ...
    private void updateAlarm() {
        ...
        mIconController.setIcon(mSlotAlarmClock, zenNone ? R.drawable.itel_stat_sys_alarm_dim
                : R.drawable.itel_stat_sys_alarm, null);
    ...
    private final void updateVolumeZen() {
        ...
        if (DndTile.isVisible(mContext) || DndTile.isCombinedIcon(mContext)) {
            ...
            zenIconId = mZen == Global.ZEN_MODE_NO_INTERRUPTIONS
                    ? R.drawable.itel_stat_sys_dnd_total_silence : R.drawable.itel_stat_sys_dnd;
            zenDescription = mContext.getString(R.string.quick_settings_dnd_label);
        } else if (mZen == Global.ZEN_MODE_NO_INTERRUPTIONS) {
            zenVisible = true;
            zenIconId = R.drawable.itel_stat_sys_zen_none;
            zenDescription = mContext.getString(R.string.interruption_level_none);
        } else if (mZen == Global.ZEN_MODE_IMPORTANT_INTERRUPTIONS) {
            zenVisible = true;
            zenIconId = R.drawable.itel_stat_sys_zen_important;
        ...
        if (DndTile.isVisible(mContext) && !DndTile.isCombinedIcon(mContext)
            ...
            volumeVisible = true;
            volumeIconId = R.drawable.itel_stat_sys_ringer_silent;
            volumeDescription = mContext.getString(R.string.accessibility_ringer_silent);
        } else if (mZen != Global.ZEN_MODE_NO_INTERRUPTIONS && mZen != Global.ZEN_MODE_ALARMS &&
                audioManager.getRingerModeInternal() == AudioManager.RINGER_MODE_VIBRATE) {
            volumeVisible = true;
            volumeIconId = R.drawable.itel_stat_sys_ringer_vibrate;
    ...
    private final void updateBluetooth() {
        int iconId = R.drawable.itel_stat_sys_data_bluetooth;
...
//                iconId = R.drawable.stat_sys_data_bluetooth_connected;
                iconId = R.drawable.itel_stat_sys_data_bluetooth_connected;
                contentDescription = mContext.getString(R.string.accessibility_bluetooth_connected);
            }
        }

        LogUtil.d("StatusBar updateBluetooth:" + mSlotBluetooth + ", contentDescription:" + contentDescription + ", bluetoothEnabled:" + bluetoothEnabled);
    ...
    private final void updateTTY(Intent intent) {
        ...
        if (enabled) {
            ...
            mIconController.setIcon(mSlotTty, R.drawable.itel_stat_sys_tty_mode,
    ...
    private void updateCast() {
        ...
        if (isCasting) {
            mIconController.setIcon(mSlotCast, R.drawable.itel_stat_sys_cast,
    ...
    private void updateManagedProfile() {
        ...
        if (mManagedProfileFocused && !mStatusBarKeyguardViewManager.isShowing()) {
            ...
            mIconController.setIcon(mSlotManagedProfile,
                    R.drawable.itel_stat_sys_managed_profile_status,
                    mContext.getString(R.string.accessibility_managed_profile));
        } else if (mManagedProfileInQuietMode) {
            showIcon = true;
            mIconController.setIcon(mSlotManagedProfile,
                    R.drawable.itel_stat_sys_managed_profile_status_off,
                    mContext.getString(R.string.accessibility_managed_profile));
        } else {
            showIcon = false;
        }
    ...
    public void onRotationLockStateChanged(boolean rotationLocked, boolean affordanceVisible) {
        ...
        if (rotationLocked) {
            if (portrait) {
                mIconController.setIcon(mSlotRotate, R.drawable.itel_stat_sys_rotate_portrait,
                        mContext.getString(R.string.accessibility_rotation_lock_on_portrait));
            } else {
                mIconController.setIcon(mSlotRotate, R.drawable.itel_stat_sys_rotate_landscape,
    ...
    private void updateHeadsetPlug(Intent intent) {
        ...
        if (connected) {
            ...
            mIconController.setIcon(mSlotHeadset, hasMic ? R.drawable.itel_ic_headset_mic
                    : R.drawable.itel_ic_headset, contentDescription);
