...
public class CommandQueue extends IStatusBar.Stub {
    ...
    private static final int MSG_TOGGLE_APP_SPLIT_SCREEN_IFPOSSIBLE = 33 << MSG_SHIFT;
    ...
    public void toggleSplitScreenIfPossible() {
        synchronized (mLock) {
            mHandler.removeMessages(MSG_TOGGLE_APP_SPLIT_SCREEN_IFPOSSIBLE);
            mHandler.obtainMessage(MSG_TOGGLE_APP_SPLIT_SCREEN_IFPOSSIBLE, 0, 0, null).sendToTarget();
        }
    }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (what) {
                ...
                case MSG_TOGGLE_APP_SPLIT_SCREEN:
                    ...
                    break;
                case MSG_TOGGLE_APP_SPLIT_SCREEN_IFPOSSIBLE:
                    mCallbacks.toggleSplitScreenIfPossible();
                    break;
            }
        }
    }
