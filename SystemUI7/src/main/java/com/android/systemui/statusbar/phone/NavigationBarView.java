...
public class NavigationBarView extends LinearLayout {
    ...
    private Drawable mPullDownIcon;
    private Drawable mPullUpIcon;
    ...
    public void updataNavigationBar(){
        if(PhoneStatusBar.mSupportDynamicBar){
            ...
            if((lastNavLayoutSettings & 0x0F) == NavigationBarInflaterView.NAVIGATION_RIGHT_NOTI
                ...
                if(null != mBar && mBar.isFullyExpanded()){
    ...
    public NavigationBarView(Context context, AttributeSet attrs) {
        ...
        mButtonDisatchers.put(R.id.pull, new ButtonDispatcher(R.id.pull));
        /* @} */
    }
    ...
    public ButtonDispatcher getPullSwitchButton() {
        return mButtonDisatchers.get(R.id.pull);
    }
    /* @} */
    ...
    private void updateIcons(Context ctx, Configuration oldConfig, Configuration newConfig) {
        ...
        if (oldConfig.densityDpi != newConfig.densityDpi) {
            ...
            /* SPRD: Bug 535100 new feature of dynamic navigationbar @{ */
            mHideIcon = ctx.getDrawable(R.drawable.ic_sysbar_hide);
            mPullDownIcon = ctx.getDrawable(R.drawable.ic_sysbar_pull_down);
            mPullUpIcon = ctx.getDrawable(R.drawable.ic_sysbar_pull_up);
            /* @} */
