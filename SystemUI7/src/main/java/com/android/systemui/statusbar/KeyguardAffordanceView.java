...
public class KeyguardAffordanceView extends ImageView {
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        mMaxCircleSize = getMaxCircleSize2();
    }
    ...
    public void finishAnimation(float velocity, final Runnable mAnimationEndRunnable) {
        ...
        if (mPreviewView != null) {
            ...
            mPreviewClipper = ViewAnimationUtils.createCircularReveal(
                    mPreviewView, getRawLeft() + mCenterX, getRawTop() + mCenterY, mCircleRadius,
                    maxCircleSize);
    ...
    public void instantFinishAnimation() {
        ...
        mCircleRadius = getMaxCircleSize2();
    ...
    private float getMaxCircleSize2() {
        return mContext.getResources().getDimension(R.dimen.hint_grow_amount_sideways);
    }
