...
public final class KeyguardMonitor extends KeyguardUpdateMonitorCallback {
    ...
    // Talpa:PeterHuang Modify for fixed tfs#11837
    /* java.util.ConcurrentModificationException
     at java.util.ArrayList$Itr.next(ArrayList.java:831)
     at com.android.systemui.statusbar.policy.KeyguardMonitor.notifyKeyguardChanged(KeyguardMonitor.java:120)
    */
    // @{
    //private final ArrayList<Callback> mCallbacks = new ArrayList<Callback>();
    private final List<Callback> mCallbacks = new CopyOnWriteArrayList<Callback>();
    // @}
