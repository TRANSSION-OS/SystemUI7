...
public class BarTransitions {
    ...
    private static class BarBackgroundDrawable extends Drawable {
        ...
        public BarBackgroundDrawable(Context context, int gradientResourceId) {
            ...
            if (DEBUG_COLORS) {
                ...
                mSemiTransparent = context.getColor(
                        Resources.getSystem().getIdentifier("system_bar_background_semi_transparent", "color","android"));
                mTransparent = context.getColor(R.color.system_bar_background_transparent);
                mWarning = context.getColor(Resources.getSystem().getIdentifier("battery_saver_mode_color", "color","android"));
            }
        ...
        public void draw(Canvas canvas) {
            ...
            /// George:When enable power save in settting,we need to avoid draw orange background
            if (mMode == MODE_WARNING) {
                return;
            }
