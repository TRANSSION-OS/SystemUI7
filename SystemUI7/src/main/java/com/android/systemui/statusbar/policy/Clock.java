...
public class Clock extends TextView implements DemoMode, Tunable {
    ...
    private float mSmallRatio = 0.7f;
    ...
    public void setSmallCharRatio(float ratio){
        mSmallRatio = ratio;
    }

    final void updateClock() {
        if (mDemoMode) {
            Log.d("Clock","updateClock mDemoMode on do not update time");
            return;
        }
    ...
    private final CharSequence getSmallTime() {
        ...
        /// George:When set 12 hour in setting,We need to show am/pm
            ...
            if (magic1 >= 0 && magic2 > magic1) {
                ...
                if (mAmPmStyle == AM_PM_STYLE_GONE) {
                    ...
                    if (mAmPmStyle == AM_PM_STYLE_SMALL) {
                        CharacterStyle style = new RelativeSizeSpan(mSmallRatio);
