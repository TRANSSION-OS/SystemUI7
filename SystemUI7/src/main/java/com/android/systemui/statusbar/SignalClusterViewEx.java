...
public class SignalClusterViewEx
    ...
    /// George: comment it and add imageview for second no sim card
    View mNoSimsCombo,mNoSimsComboSecond;
    ImageView mVpn, mEthernet, mWifi,/* mVolte, mHdVoice,*/ mAirplane, mNoSims,mNoSimsSecond,
        mEthernetDark, mWifiDark, mNoSimsDark,mNoSimsDarkSecond;
    boolean isSimOneExist = false,isSimTwoExist = false;
    ///
    ...
    /// George: comment it,  wo use others instead
   ...
   /*  private boolean mShowNoSims = mContext.getResources().getBoolean(
    ...
    protected void onFinishInflate() {
        ...
        //SPRD: Bug #474463 Add wifi inOut icon in status bar Feature BEG-->
        /// George: comment it,  wo use other instead
       /// mWifiIn = (ImageView) findViewById(R.id.wifi_in);
        ///mWifiOut = (ImageView) findViewById(R.id.wifi_out);
        //<-- Add wifi inOut icon in status bar Feature END
        mAirplane       = (ImageView) findViewById(R.id.airplane);
        mNoSims         = (ImageView) findViewById(R.id.no_sims);
        mNoSimsSecond         = (ImageView) findViewById(R.id.no_sims_second);
        mNoSimsDark     = (ImageView) findViewById(R.id.no_sims_dark);
        mNoSimsDarkSecond    = (ImageView) findViewById(R.id.no_sims_dark_second);
        mNoSimsCombo    =             findViewById(R.id.no_sims_combo);
        mNoSimsComboSecond = findViewById(R.id.no_sims_combo_second);
    ...
    private void maybeScaleVpnAndNoSimsIcons() {
        ...
        /// George:add for second no sim card imageView
        mNoSimsSecond.setImageDrawable(
                new ScalingDrawableWrapper(mNoSimsSecond.getDrawable(), mIconScaleFactor));
        mNoSimsDarkSecond.setImageDrawable(
                new ScalingDrawableWrapper(mNoSimsDarkSecond.getDrawable(), mIconScaleFactor));
        ///
    }
    ...
    protected void onAttachedToWindow() {
      ...
      //  mMobileSignalGroup.setPaddingRelative(mMobileSignalGroupEndPadding, 0, mMobileSignalGroupEndPadding, 0);
    ...
    public void setMobileDataIndicators(IconState statusIcon, IconState qsIcon, int statusType,
            ...
            String description, boolean isWide, int subId,int volteType) {
    ...
    public void setMobileVolteIndicators(boolean show, int subId, int resId) {
        /// George: change it from show to false;
        mVolteVisible = false;
        mVolteIconId = resId;
        /* SPRD: modify by BUG 606106 @{ */
        if (show) {
    ...
    private void apply() {
       ...
       /// George:add for second no sim card imageView
        mNoSimsCombo.setVisibility(mIsAirplaneMode||isSimOneExist ? View.GONE : View.VISIBLE);
        mNoSimsComboSecond.setVisibility(mIsAirplaneMode||isSimTwoExist ?  View.GONE : View.VISIBLE);
        /*}*/
        //@}

        boolean anythingVisible = isSimOneExist||isSimTwoExist||mNoSimsVisible || mWifiVisible || mIsAirplaneMode
    ...
    private void applyIconTint() {
        ...
        /// George:add for the second sim card image color filter
        setTint(mNoSimsSecond, StatusBarIconController.getTint(mTintArea, mNoSimsSecond, mIconTint));
        //applyDarkIntensity(
    ...
    private class PhoneState {
        ...
        private ImageView mMobile, mMobileDark, mMobileType, mMobileDataInOut,
                mMobileRoam;
        /// George: // Add for [Network Type and volte on Statusbar]
        ...
        public void setViews(ViewGroup root) {
            ...
            /// George:add for volte for  both mtk and sprid platform
            mVolteType      = (ImageView) root.findViewById(R.id.volte);
        }
        ...
        public boolean apply(boolean isSecondaryIcon) {
            if (mMobileVisible && !mIsAirplaneMode) {
                ...
                if (mDataConnected) {
                    if (mActivityIn && mActivityOut) {
                        ...
                        // talpa@andy 2017/4/21 17:27 modify @{
            ...
            /// George add volte for both mtk and sprid
            setVolteIcon();

            // When this isn't next to wifi, give it some extra padding between the signals.
            /*mMobileGroup.setPaddingRelative(isSecondaryIcon ? mSecondaryTelephonyPadding : 0,
                    0, 0, 0);*/
            /// George:change this for the padding between no sim card and signal ,this is important
            mMobileGroup.setPaddingRelative(mSecondaryTelephonyPadding ,
                    0, 0, 0);
           ...
           /* mMobile.setPaddingRelative(
            ...
            // talpa@andy 2017/4/21 14:58 add @{
            mMobileDataInOut.setVisibility(mMobileDataInOutId != 0? View.VISIBLE : View.GONE);
            // @}
        ...
        public void setIconTint(int tint, float darkIntensity, Rect tintArea) {
            ...
            /// George:add for both mtk and sprid platform
            setTint(mVolteType, StatusBarIconController.getTint(tintArea, mVolteType, tint));

            /// George: comment it,  we use other instead
        ...
        /* @} */
        /// M: Add for volte icon on Statusbar/// George add for both mtk and sprid @{
