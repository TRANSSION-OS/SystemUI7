...
public class DemoStatusIcons extends LinearLayout implements DemoMode {
    ...
    public void dispatchDemoCommand(String command, Bundle args) {
        if (!mDemoMode && command.equals(COMMAND_ENTER)) {
            ...
            if (volume != null) {
                int iconId = volume.equals("vibrate") ? R.drawable.itel_stat_sys_ringer_vibrate
                        : 0;
                updateSlot("volume", null, iconId);
            }
            String zen = args.getString("zen");
            if (zen != null) {
                int iconId = zen.equals("important") ? R.drawable.itel_stat_sys_zen_important
                        : zen.equals("none") ? R.drawable.itel_stat_sys_zen_none
                        : 0;
                updateSlot("zen", null, iconId);
            }
            String bt = args.getString("bluetooth");
            if (bt != null) {
                int iconId = bt.equals("disconnected") ? R.drawable.itel_stat_sys_data_bluetooth
                        : bt.equals("connected") ? R.drawable.itel_stat_sys_data_bluetooth_connected
                        : 0;
            ...
            if (alarm != null) {
                int iconId = alarm.equals("show") ? R.drawable.itel_stat_sys_alarm
                        : 0;
                updateSlot("alarm_clock", null, iconId);
            }
            String tty = args.getString("tty");
            if (tty != null) {
                int iconId = tty.equals("show") ? R.drawable.itel_stat_sys_tty_mode
                        : 0;
            ...
            if (cast != null) {
                int iconId = cast.equals("show") ? R.drawable.itel_stat_sys_cast : 0;
                updateSlot("cast", null, iconId);
            }
            String hotspot = args.getString("hotspot");
            if (hotspot != null) {
                int iconId = hotspot.equals("show") ? R.drawable.itel_stat_sys_hotspot : 0;
