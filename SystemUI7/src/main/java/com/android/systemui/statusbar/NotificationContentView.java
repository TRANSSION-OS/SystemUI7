...
public class NotificationContentView extends FrameLayout {
    ...
    public NotificationContentView(Context context, AttributeSet attrs) {
        ...
        mNotificationContentMarginEnd = getResources().getDimensionPixelSize(TalpaResUtil.android.dimen.notification_content_margin_end());
        reset();
    }
    ...
    private int getMinContentHeightHint() {
        if (mIsChildInGroup && isVisibleOrTransitioning(VISIBLE_TYPE_SINGLELINE)) {
            return mContext.getResources().getDimensionPixelSize(TalpaResUtil.android.dimen.notification_action_list_height());
        }
        ...
        if (mHeadsUpChild != null && isVisibleOrTransitioning(VISIBLE_TYPE_HEADSUP)) {
            ...
            hint = mContractedChild.getHeight() + mContext.getResources().getDimensionPixelSize(
                    TalpaResUtil.android.dimen.notification_action_list_height());
        }
    ...
    private RemoteInputView applyRemoteInput(View view, NotificationData.Entry entry,
        ...
        View actionContainerCandidate = view.findViewById(TalpaResUtil.android.id.actions_container());
