...
public class StatusBarKeyguardViewManager implements RemoteInputController.Callback {
    ...
    public void registerStatusBar(PhoneStatusBar phoneStatusBar,
        ...
        //linwujia add begin
        mBouncer.setPhoneStatusBar(mPhoneStatusBar);
        //linwujia add end
        /** Fix bug 515756 lock screen shaking to changed song  {@ **/
    ...
    public void dismissWithAction(OnDismissAction r, Runnable cancelAction,
        ...
        if (mShowing) {
            mPhoneStatusBar.hideKeyguard(); // add by lych for hide the keyguard when double clicked the notification
    ...
    public void dismiss() {
        if (DEBUG) {
            Log.d(TAG, "dismiss(); mDeviceInteractive = " + mDeviceInteractive + "; " +
                    "mDeviceWillWakeUp = " + mDeviceWillWakeUp);
        }
