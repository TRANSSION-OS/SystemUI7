                ...
                if (datatype != null) {
                    controller.getState().iconGroup =
                            ...
                            datatype.equals("4g") ? TelephonyIcons.FOUR_G :
                                    /// George:comment it because we dont need this state
    ...
    static class Config {
        ...
        static Config readConfig(Context context) {
            ...
            config.alwaysShowCdmaRssi =
                    res.getBoolean(Resources.getSystem().getIdentifier("config_alwaysUseCdmaRssi", "bool","android"));
