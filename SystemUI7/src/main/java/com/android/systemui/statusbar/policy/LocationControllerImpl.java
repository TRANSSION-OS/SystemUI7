...
public class LocationControllerImpl extends BroadcastReceiver implements LocationController {
    ...
    public static final int LOCATION_STATUS_ICON_ID = R.drawable.itel_stat_sys_location;
    ...
    public LocationControllerImpl(Context context, Looper bgLooper) {
        mContext = context;
        mSlotLocation = mContext.getString(Resources.getSystem().getIdentifier("status_bar_location", "string","android"));
