...
import static com.sprd.keyguard.KeyguardSupportAmPm.mContext;
...
public class KeyguardBottomAreaView extends FrameLayout implements View.OnClickListener,
    ...
    //linwujia add begin
    private View mPanelViewBottom;
    private TextView mDateView;
    private Clock mTimeView;
    private View mBottomMask;//add by wangying
    ...
    protected void onFinishInflate() {
        ...
        //mPreviewContainer = (ViewGroup)mPhoneStatusBar.mNotificationPanel.findViewById(R.id.preview_container);
        mCameraImageView = (KeyguardAffordanceView) findViewById(R.id.camera_button);
        //mLeftAffordanceView = (KeyguardAffordanceView) findViewById(R.id.left_button);
        //mLockIcon = (LockIcon) findViewById(R.id.lock_icon);
        //linwujia add begin
        mPanelViewBottom = findViewById(R.id.btPanel_bottom);
        //add by wangying begin
        mBottomMask = findViewById(R.id.keyguard_bottom_mask);
        mBottomMask.setBackgroundResource(R.drawable.ic_qs_bottom_background);
        //add by wangying end
        mDateView = (TextView) findViewById(R.id.tv_date);
        mTimeView = (Clock) findViewById(R.id.tv_time);
        ...
        mTimeView.setSmallCharRatio(0.4f);
        //linwujia add end
    ...
    protected void onConfigurationChanged(Configuration newConfig) {
        ...
        mIndicationText.setTextSize(TypedValue.COMPLEX_UNIT_PX,
                getResources().getDimensionPixelSize(
                        Resources.getSystem().getIdentifier("text_size_small_material", "dimen","android")));
        ...
        if (!SystemuiFeatureUtil.getInstance().isCMCC()) {
            mCameraImageView.setImageDrawable(mContext.getDrawable(R.drawable.itel_ic_camera_alt_24dp));
        }
    ...
    private void updateCameraVisibility() {
        ...
        boolean visible = !isCameraDisabledByDpm() && resolved != null
                ...
                && mUserSetupComplete;
        mCameraImageView.setVisibility((visible && !TalpaUtils.isSuperPowerSaveMode(mContext)) ? View.VISIBLE : View.GONE);
    }
    ...
    public View getRightPreview() {
        // add by wangying begin tfs Bug 12476
    ...
    public View getPanelViewBottom() {
        return mPanelViewBottom;
    }

    public void setBottomMaskVisibility(int visibility){
        if(mBottomMask == null) return;
        if(mBottomMask.getVisibility() != visibility){
            mBottomMask.setVisibility(visibility);
        }
    }
}
