...
public class NotificationHeaderViewWrapper extends NotificationViewWrapper {
    ...
    protected void resolveHeaderViews() {
        mIcon = (ImageView) mView.findViewById(TalpaResUtil.android.id.icon());
        mExpandButton = (ImageView) mView.findViewById(TalpaResUtil.android.id.expand_button());
        mColor = resolveColor(mExpandButton);
        mNotificationHeader = (NotificationHeaderView) mView.findViewById(TalpaResUtil.android.id.notification_header());
    }
