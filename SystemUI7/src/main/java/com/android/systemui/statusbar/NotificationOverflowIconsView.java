...
public class NotificationOverflowIconsView extends IconMerger {
    ...
    protected void onFinishInflate() {
        ...
        mIconSize = getResources().getDimensionPixelSize(
                TalpaResUtil.android.dimen.status_bar_icon_size());
    }
    ...
    public void addNotification(NotificationData.Entry notification, String packageName) {
        StatusBarIconView v = new StatusBarIconView(getContext(), "",
                notification.notification.getNotification());
        v.setScaleType(ImageView.ScaleType.CENTER_INSIDE);
        addView(v, mIconSize, mIconSize);
        v.set(notification.icon.getStatusBarIcon(), packageName);
