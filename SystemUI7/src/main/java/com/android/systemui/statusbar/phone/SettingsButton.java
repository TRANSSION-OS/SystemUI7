...
//        LogUtil.i("SettingsButton>onTouchEvent="+event.getActionMasked());
        switch (event.getActionMasked()) {
            ...
            case MotionEvent.ACTION_MOVE:
                float x = event.getX();
                float y = event.getY();
//                Log.i("SettingsButton", "SettingsButton>x="+x+"|y="+y+"|width="+getWidth()+"|hight="+getHeight());
                if ((x < -mSlop) || (y < -mSlop) || (x > getWidth() + mSlop)
                        || (y > getHeight() + mSlop)) {
                    cancelLongClick();
//                    Log.i("SettingsButton", "SettingsButton>ACTION_MOVE>x="+x+"|y="+y);
                }
                break;
        }
