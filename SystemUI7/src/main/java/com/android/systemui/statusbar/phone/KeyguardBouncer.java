...
public class KeyguardBouncer {
    ...
    public void show(boolean resetSecuritySelection) {
        ...
        // removed begin by lych for gpu overdraw
        /*
        //linwujia add begin
        ImageView imageView = mPhoneStatusBar.getBackDropBack();
        Drawable drawable = null;
        if(imageView != null) {
            drawable = imageView.getDrawable();
            if(drawable == null && mPhoneStatusBar.getWallpagerManager() != null) {
                drawable = mPhoneStatusBar.getWallpagerManager().getDrawable();
            }
        }
        ...
        if(drawable != null) {
            ...
            layers[0] = drawable;
            ColorDrawable colorDrawable = new ColorDrawable(0xB3000000);
            layers[1] = colorDrawable;
            LayerDrawable layerDrawable = new LayerDrawable(layers);
            mRoot.setBackground(layerDrawable);
        }
        //linwujia add end
        */
        // removed end by lych for gpu overdraw
    ...
    public boolean needsFullscreenBouncer() {
        ...
        if (mKeyguardView != null) {
            ...
            return mode == SecurityMode.SimPin || mode == SecurityMode.SimPuk || mode == SecurityMode.AlarmBoot;
        }
        return false;
    }
