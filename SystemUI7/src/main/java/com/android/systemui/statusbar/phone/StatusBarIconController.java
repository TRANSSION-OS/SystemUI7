...
public class StatusBarIconController extends StatusBarIconList implements Tunable {
    ...
    public StatusBarIconController(Context context, View statusBar, View keyguardStatusBar,
        ...
        /// George: add for IconTint
        mChargeView = (ImageView)statusBar.findViewById(R.id.itel_battery_charging);
        //linwujia add begin
    ...
    private void scaleBatteryMeterViews(Context context) {
        ...
        int batteryHeight = res.getDimensionPixelSize(R.dimen.itel_battery_height_dimen);
        int batteryWidth = res.getDimensionPixelSize(R.dimen.itel_battery_width_dimen);
    ...
    private void loadDimens() {
        mIconSize = mContext.getResources().getDimensionPixelSize(
                Resources.getSystem().getIdentifier("status_bar_icon_size", "dimen","android"));
        mIconHPadding = mContext.getResources().getDimensionPixelSize(
                R.dimen.itel_status_bar_icon_padding);
    }

    public void defineSlots() {
        defineSlots(mContext.getResources().getStringArray(
                Resources.getSystem().getIdentifier("config_statusBarIcons", "array","android")));
    }
    ...
    private void addSystemIcon(int index, StatusBarIcon icon) {
        ...
        Log.d("StatusBar", "addSystemIcon mIconHPadding:" + mIconHPadding);
    ...
    public void setIcon(String slot, int resourceId, CharSequence contentDescription) {
        ...
        LogUtil.d("StatusBar index:" + index + ", icon is null:" + (icon == null));
        if (icon == null) {
    ...
    public void setIcon(int index, StatusBarIcon icon) {
        if (icon == null) {
            LogUtil.d("StatusBar removeIcon(" + index + ")");
            removeIcon(index);
            return;
        }
        ...
        if (isNew) {
            LogUtil.d("StatusBar addSystemIcon(" + index + "," + icon + ")");
    ...
    private static boolean isInArea(Rect area, View view) {
        ...
        LogUtil.d("StatusBarIconController isInArea:" + (majorityOfWidth && coversFullStatusBar));
    ...
    private void applyIconTint() {
        ...
        /// George:add for IconTint for chargeview
        mChargeView.setImageTintList(ColorStateList.valueOf(getTint(mTintArea, mChargeView, mIconTint)));
        //linwujia add begin
    ...
    public static ArraySet<String> getIconBlacklist(String blackListStr) {
        ...
        if (blackListStr == null) {
            /// M: enable headset icon. /// George:mtk modify it for an headset statusIcon in statusBar
    ...
    private void updateClock() {
        FontSizeUtils.updateFontSize(mClock, /*R.dimen.status_bar_clock_size*/R.dimen.itel_status_bar_clock_size);
        mClock.setPaddingRelative(
                /*mContext.getResources().getDimensionPixelSize(
                        R.dimen.status_bar_clock_starting_padding)*/
                mContext.getResources().getDimensionPixelSize(
                        R.dimen.itel_status_bar_clock_starting_padding),
                0,
                mContext.getResources().getDimensionPixelSize(
    ...
    //linwujia add begin for fix cdn bug#9334,9431
    public void onConfigurationChanged() {
        LogUtil.d("StatusBarIconController onConfigurationChanged");
        applyIconTint();
        mNotificationIconAreaController.onConfigurationChanged();
    }
    //linwujia add end
}
