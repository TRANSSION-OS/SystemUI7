...
public class NotificationHeaderUtil {
    ...
    private final static ResultApplicator mGreyApplicator = new ResultApplicator() {
        ...
        public void apply(View view, boolean apply) {
            ...
            ImageView icon = (ImageView) view.findViewById(TalpaResUtil.android.id.icon());
            ImageView expand = (ImageView) view.findViewById(TalpaResUtil.android.id.expand_button());
        ...
        private void applyToChild(View view, boolean shouldApply, int originalColor) {
            if (originalColor != NotificationHeaderView.NO_COLOR) {
                ...
                if (shouldApply) {
                    // lets gray it out
                    int grey = view.getContext().getColor(TalpaResUtil.android.color.notification_icon_default_color());
    ...
    public NotificationHeaderUtil(ExpandableNotificationRow row) {
        ...
        mComparators.add(new HeaderProcessor(mRow,
                TalpaResUtil.android.id.notification_header(),
                sIconExtractor,
                sGreyComparator,
                mGreyApplicator));
        mComparators.add(new HeaderProcessor(mRow,
                TalpaResUtil.android.id.profile_badge(),
                null /* Extractor */,
                new ViewComparator() {
                    @Override
                    public boolean compare(View parent, View child, Object parentData,
        ...
        mComparators.add(HeaderProcessor.forTextView(mRow,
                TalpaResUtil.android.id.app_name_text()));
        mComparators.add(HeaderProcessor.forTextView(mRow,
                TalpaResUtil.android.id.header_text()));
        mDividers.add(TalpaResUtil.android.id.header_text_divider());
        mDividers.add(TalpaResUtil.android.id.time_divider());
    }
    ...
    private void sanitizeHeader(NotificationHeaderView rowHeader) {
        ...
        View time = rowHeader.findViewById(TalpaResUtil.android.id.time());
