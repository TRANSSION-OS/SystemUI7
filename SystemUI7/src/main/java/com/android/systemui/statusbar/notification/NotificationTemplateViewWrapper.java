...
public class NotificationTemplateViewWrapper extends NotificationHeaderViewWrapper {
    ...
    private void resolveTemplateViews(StatusBarNotification notification) {
        mPicture = (ImageView) mView.findViewById(TalpaResUtil.android.id.right_icon());
        mPicture.setTag(ImageTransformState.ICON_TAG,
                notification.getNotification().getLargeIcon());
        mTitle = (TextView) mView.findViewById(TalpaResUtil.android.id.title());
        mText = (TextView) mView.findViewById(TalpaResUtil.android.id.text());
        final View progress = mView.findViewById(TalpaResUtil.android.id.progress());
        ...
        mActionsContainer = mView.findViewById(TalpaResUtil.android.id.actions_container());
    }
    ...
    protected void updateInvertHelper() {
        ...
        View mainColumn = mView.findViewById(TalpaResUtil.android.id.notification_main_column());
        if (mainColumn != null) {
