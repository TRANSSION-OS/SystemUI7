...
public class PowerNotificationWarnings implements PowerUI.WarningsUI {
    ...
    private void showInvalidChargerNotification() {
        final Notification.Builder nb = new Notification.Builder(mContext)
                ...
                .setColor(mContext.getColor(
                        Resources.getSystem().getIdentifier("system_notification_accent_color", "color","android")));
    ...
    private void showWarningNotification() {
        ...
        final Notification.Builder nb = new Notification.Builder(mContext)
                ...
                .setVisibility(Notification.VISIBILITY_PUBLIC)
                .setColor(mContext.getColor(
                        Resources.getSystem().getIdentifier("battery_saver_mode_color", "color","android")));
    ...
    private void showStartSaverConfirmation() {
        ...
        d.setMessage(Resources.getSystem().getIdentifier("battery_saver_description", "string","android"));
