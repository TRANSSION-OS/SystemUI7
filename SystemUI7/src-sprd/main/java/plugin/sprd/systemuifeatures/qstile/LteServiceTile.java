...
//        }
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        if (!isAirplaneModeOn()) {
            //talpa zhw updateLteEnabledState();
        }
...
//      state.visible = true;
        ...
        if (mLteEnabled && mLteAvailable
            ...
            state.icon = ResourceIcon.get(R.drawable.itel_ic_qs_4g_on_ex/*talpa zhw ic_qs_4g_on_ex*/);
            state.contentDescription =  mContext.getString(
                    R.string.accessibility_quick_settings_lte_on);
        } else {
            // SPRD: Replace the LTE switch icon.
            state.icon = ResourceIcon.get(R.drawable.itel_ic_qs_4g_off_ex/*talpa zhw ic_qs_4g_off_ex*/);
            state.contentDescription =  mContext.getString(
                    R.string.accessibility_quick_settings_lte_off);
        }
        //talpa zhw add
        state.bottomIcon = ResourceIcon.get(R.drawable.itel_ic_qs_4g_bottom);
        //talpa zhw add end
    }
