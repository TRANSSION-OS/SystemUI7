...
public class DreamBackend {
    ...
    public DreamBackend(Context context) {
        ...
        mDreamsEnabledByDefault = context.getResources()
                .getBoolean(Resources.getSystem().getIdentifier("config_dreamsEnabledByDefault", "bool","android"));
        mDreamsActivatedOnSleepByDefault = context.getResources()
                .getBoolean(Resources.getSystem().getIdentifier("config_dreamsActivatedOnSleepByDefault", "bool","android"));
        mDreamsActivatedOnDockByDefault = context.getResources()
                .getBoolean(Resources.getSystem().getIdentifier("config_dreamsActivatedOnDockByDefault", "bool","android"));
    }
    ...
    public List<DreamInfo> getDreamInfos() {
        ...
        /* SPRD: Add for Bug 597923, check whether it has checked any item. @{ */
