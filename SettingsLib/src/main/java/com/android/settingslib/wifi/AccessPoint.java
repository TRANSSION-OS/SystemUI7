...
public class AccessPoint implements Comparable<AccessPoint>, Cloneable {
    ...
    public static final int SECURITY_PSK_SHA256 = 6;
    public static final int SECURITY_EAP_SHA256 = 7;
    //<-- Add for wifi Advance Feature END

    //SPRD: Bug #474464 Porting WAPI feature to AndroidN BEG-->
    public static final int SECURITY_WAPI_PSK = 8;
    public static final int SECURITY_WAPI_CERT = 9;
    //<-- Porting WAPI feature to AndroidN END
    ...
    private void initWithScanResult(ScanResult result) {
        ...
        //itel@andy add:platform diff @{
        if (TalpaUtils.isSPRDPlatform()) {
            //SPRD: Bug #474443 Porting cmcc wifi features to AndroidN -->
            mWifiManagerEx = new WifiManagerEx(mContext);
