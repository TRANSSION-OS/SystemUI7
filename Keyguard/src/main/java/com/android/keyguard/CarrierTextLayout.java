...
public class CarrierTextLayout extends LinearLayout {
    ...
    public CarrierTextLayout(Context context, AttributeSet attrs) {
        ...
        mIsEmergencyCallCapable = context.getResources().getBoolean(
                Resources.getSystem().getIdentifier("config_voice_capable", "bool","android"));
    ...
    protected void updateCarrierText() {
        ...
        // Talpa: DepingHuang Fixed cdn#8514      Modified Resources.getSystem().getIdentifier --> R.bool @{
        /* boolean showEmergencyOnly = mContext.getResources().getBoolean(
                Resources.getSystem().getIdentifier("config_showEmergencyCallOnly", "bool","android"));*/
        boolean showEmergencyOnly = mContext.getResources().getBoolean(R.bool.config_showEmergencyCallOnly);
        // @}
        CharSequence emergencyCall = getContext()
                .getText(Resources.getSystem().getIdentifier("emergency_calls_only", "string","android"));
        CharSequence noService = getContext()
                .getText(Resources.getSystem().getIdentifier("lockscreen_carrier_default", "string","android"));
        /* @} */
