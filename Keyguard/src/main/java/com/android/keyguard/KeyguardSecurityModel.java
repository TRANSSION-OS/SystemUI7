...
public class KeyguardSecurityModel {
    ...
    public enum SecurityMode {
        ...
        AlarmBoot // add for power-off alarm. George Add
    }
    ...
    KeyguardSecurityModel(Context context) {
        ...
        mIsPukScreenAvailable = mContext.getResources().getBoolean(
                Resources.getSystem().getIdentifier("config_enable_puk_unlock_screen", "bool","android"));
    }
    ...
    SecurityMode getSecurityMode() {
        ...
        {
		    if (PowerOffAlarmManager.isAlarmBoot()) { /// M: add for power-off alarm George Add
