...
class KeyguardMessageArea extends TextView implements SecurityMessageDisplay {
    ...
    CharSequence mDefaultMessage;//zhw add
    ...
    //zhw add\
    public void setDefaultMessage(int resId, boolean important) {
        this.mDefaultMessage = getContext().getResources().getText(resId);
    }
    //zhw add end
