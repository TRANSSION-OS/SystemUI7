...
public class EmergencyButton extends Button {
    ...
    public EmergencyButton(Context context, AttributeSet attrs) {
        ...
        mEnableEmergencyCallWhileSimLocked = mContext.getResources().getBoolean(
                Resources.getSystem().getIdentifier("config_enable_emergency_call_while_sim_locked", "bool","android"));
    }
    ...
    public void takeEmergencyCallAction() {
        ...
        if (isInCall()) {
            resumeCall();
            // talpa@wangying 2017/6/5 18:00 modify:fix bug cdn 10319 保持原生，bug 10192不能通过屏蔽这段代码修复@{ 
    ...
    private void updateEmergencyCallButton() {
        ...
        if (visible) {
            ...
            int textId;
            if (isInCall()) {
                textId = Resources.getSystem().getIdentifier("lockscreen_return_to_call", "string","android");
            } else {
                //textId = Resources.getSystem().getIdentifier("lockscreen_emergency_call", "string","android");
